...
# Time-stamp: <2025-03-15 22:48:28 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-03-15 Sa 22:48]
   | Headline                        | Time    |         |      |      |      |      |
   |---------------------------------+---------+---------+------+------+------+------|
   | *Total time*                    | *12:14* |         |      |      |      |      |
   |---------------------------------+---------+---------+------+------+------+------|
   | *RPG [1/6]*                     | *12:14* |         |      |      |      |      |
   | \_  /Components [1/6]/          |         | /12:14/ |      |      |      |      |
   | \_    Engine [0/4]              |         |         | 6:57 |      |      |      |
   | \_      Mechanics [0/3]         |         |         |      | 5:12 |      |      |
   | \_        Talk to me! [0/1]     |         |         |      |      | 1:22 |      |
   | \_          A state machine?    |         |         |      |      |      | 1:06 |
   | \_    UI [1/2]                  |         |         | 5:17 |      |      |      |
   | \_      Prompt                  |         |         |      | 2:07 |      |      |
